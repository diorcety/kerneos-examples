...
public class StartListenCommand implements ICommand, IResponder {
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().startListen((event as SimpleCommandEvent).ident);
    }
    ...
    public function fault(info:Object):void {
        ...
        var exc:ServerSideException = new ServerSideException(
                "Error while trying to listen results",
