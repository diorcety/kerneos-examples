...
public class StartProbeCommand implements ICommand, IResponder {

    public function StartProbeCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().startProbe(ident);
    }
    ...
    public function result(event:Object):void {
        ...
        // Set selected probe in model.
        model.selectedProbeIdent = ident;

        // Tell the view it's OK
        var notif:NotificationEvent = new NotificationEvent("Probe #" + ident + " has been started");
