...
public class NewTargetCommand implements ICommand, IResponder {

    public function NewTargetCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().newTarget((event as TargetCommandEvent).probetarget);
    }
    ...
    public function fault(info:Object):void {
        ...
        var exc:ServerSideException = new ServerSideException(
                "Error while modifying target list",
