...
public class NewOutputCommand implements ICommand, IResponder {

    public function NewOutputCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().newOutput((event as OutputCommandEvent).probeoutput);
    }
    ...
    public function fault(info:Object):void {
        ...
        var exc:ServerSideException = new ServerSideException(
                "Error while modifying output list",
