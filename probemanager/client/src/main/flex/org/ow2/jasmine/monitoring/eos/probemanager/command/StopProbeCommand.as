...
public class StopProbeCommand implements ICommand, IResponder {

    public function StopProbeCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().stopProbe(ident);
    }
    ...
    public function result(event:Object):void {
        ...
        var notif:NotificationEvent = new NotificationEvent("Probe #" + ident + " has been stopped");
