...
public class ModifyOutputCommand implements ICommand, IResponder {

    public function ModifyOutputCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().modifyOutput((event as OutputCommandEvent).probeoutput);
    }
