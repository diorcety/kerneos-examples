...
public class LoadConfCommand implements ICommand, IResponder {

    public function LoadConfCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        url = (event as SimpleCommandEvent).name;
        model.getDelegate().loadConf(url);
    }
    ...
    public function result(event:Object):void {
        ...
        var notif:NotificationEvent = new NotificationEvent("Configuration file loaded: " + url);
