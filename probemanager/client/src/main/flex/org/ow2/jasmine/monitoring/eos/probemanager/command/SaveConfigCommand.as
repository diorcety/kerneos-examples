...
public class SaveConfigCommand implements ICommand, IResponder {

    public function SaveConfigCommand():void {}
    ...
    public function result(event:Object):void {
        ...
        var notif:NotificationEvent = new NotificationEvent("Probe Manager Configuration has been saved");
    ...
    public function fault(info:Object):void {
        ...
        var exc:ServerSideException = new ServerSideException(
                "Error while trying to save configuration",
