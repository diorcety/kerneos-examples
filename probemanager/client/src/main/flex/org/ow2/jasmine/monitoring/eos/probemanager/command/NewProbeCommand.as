...
public class NewProbeCommand implements ICommand, IResponder {

    public function NewProbeCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().newProbe((event as ProbeCommandEvent).probe);
    }
    ...
    public function result(event:Object):void {
        ...
        var notif:NotificationEvent = new NotificationEvent("New probe created: #" + probeIdent);
