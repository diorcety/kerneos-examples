...
public class RemoveOutputCommand implements ICommand, IResponder {

    public function RemoveOutputCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().removeOutput((event as SimpleCommandEvent).name);
    }
