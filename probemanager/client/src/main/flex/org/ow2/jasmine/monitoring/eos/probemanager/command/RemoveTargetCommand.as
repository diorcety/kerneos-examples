...
public class RemoveTargetCommand implements ICommand, IResponder {

    public function RemoveTargetCommand():void {}
    ...
    public function execute(event:CairngormEvent):void {
        ...
        model.getDelegate().removeTarget((event as SimpleCommandEvent).name);
    }
